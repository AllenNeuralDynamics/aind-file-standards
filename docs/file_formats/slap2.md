...
Beyond that leading stem, the punctuation, datetime format, and suffix ordering shown above are determined by the MBF Bioscience SLAP2 microscope software and are documented here as generated rather than redefined by Allen Institute / Neural Dynamics. These filenames do not follow the datetime and word-separator conventions in `core-standards.md` because the naming is generated by the MBF Bioscience SLAP2 software and is outside the control of Allen Institute / Neural Dynamics.
